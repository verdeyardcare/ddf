...
public class SolrQueryFilterVisitorTest {
    ...
    public void testAnd() throws Exception {
        ...
        SolrQuery solrQuery = (SolrQuery) filter.accept(solrVisitor, null);
        assertThat(solrQuery.getQuery().trim(), equalTo("( property_txt:\"val\" AND otherProp_txt:\"val2\" )"));
    }
    ...
    public void testOr() throws Exception {
        ...
        SolrQuery solrQuery = (SolrQuery) filter.accept(solrVisitor, null);
        assertThat(solrQuery.getQuery().trim(), equalTo("( property_txt:\"val\" OR otherProp_txt:\"val2\" )"));
    }
